...
export default function DashboardPreview() {
  ...
  const { rotateX, rotateY, handleMove, handleLeave } = useTilt(10); // reduced tilt
  ...
  return (
    <motion.div
      ...
      className="relative w-[360px] sm:w-[460px] md:w-[560px] 
      rounded-3xl bg-[#0b0b12]/90 border border-white/20 
      p-6 shadow-[0_80px_200px_rgba(0,0,0,0.9)] overflow-hidden"
    >
      {/* 🔥 SUBTLE TOP LIGHT */}
